...
class Form extends Component
{
    ...
    public function save(): void
    {
        ...
        $this->form->reset();
        $this->dispatch('record-created', ['modal' => "country-form-modal" ]);
    }
    ...
    public function edit()
    {
        $this->validate();
        $this->form->code = Application::find(Country::application())->code . '-' . strtoupper($this->form->code);
        Country::find($this->form->id)->update($this->form->all());
        $this->dispatch('record-updated', ['modal' => "country-form-modal" ]);
    }

    public function render()
    {
        return view('livewire.methods.general.world.countries.form');
    }
}
