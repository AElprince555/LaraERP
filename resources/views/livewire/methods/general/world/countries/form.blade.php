<div>
    ...
    >
        <div class="p-3 pt-5">
            <h2 class="font-extrabold">{{$form->id ?"Update Country $form->name" : "Create New Country" }}</h2>
        </div>
        ...
        <div class="p-3 mt-3">
            ...
            <div class="mt-5">
                ...
                <x-danger-button
                    ...
                    x-on:click="$dispatch('close' , 'country-form-modal')"
                >
                    Cancel
                </x-danger-button>
            </div>
